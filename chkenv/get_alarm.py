...
try:
    ...
    if result:
        for r in result:
            content='000000006008'+'*机房环境告警*'+ datetime.datetime.strftime(r[4], '%m-%d %H:%M')+' ' + r[0].encode('Latin1').decode('gbk') + r[1].encode('Latin1').decode('gbk') + ' ' + r[2].encode('Latin1').decode('gbk')+' '+r[3].encode('Latin1').decode('gbk')
